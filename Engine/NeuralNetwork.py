...
class NeuralNetwork():
    ...
    def __init__(self, hidden_layers_sizes, activation_func=None, is_clasification=True, loss=None, learning_rate=0.5, max_iter=100, max_loss=0.1, regularization=None, r_coef=0.01):
        """
